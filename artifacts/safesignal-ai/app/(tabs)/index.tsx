  ...
  return (
    <Page active="route" onNavigate={onNavigate} topInset={topInset}>
      ...
      <TouchableOpacity onPress={() => setSelectedRoute('safe')} activeOpacity={0.88} style={[styles.routeCard, selectedRoute === 'safe' && styles.routeCardSelected, { borderLeftColor: C.success }]}>
        ...
        <Text style={styles.routeStats}>20 min  ·  13.8 km  ·  <Text style={{ color: C.success }}>Risk: Low</Text></Text>
        <View style={styles.chipRow}><View style={styles.successChip}><Text style={styles.chipTextSuccess}>Kolapakkam</Text></View><View style={styles.successChip}><Text style={styles.chipTextSuccess}>Manapakkam</Text></View><View style={styles.successChip}><Text style={styles.chipTextSuccess}>Nandambakkam</Text></View></View>
      </TouchableOpacity>
